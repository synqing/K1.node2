...
export default function EffectSelector({ selectedEffect, onEffectChange, disabled }: EffectSelectorProps) {
  return (
        ...
        {effects.map((effect) => (
          <button
            ...
            className={`
              ...
              flex items-center gap-3 ${disabled ? '' : 'hover:bg-k1-surface-hover'}
