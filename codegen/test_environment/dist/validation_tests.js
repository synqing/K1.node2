 ...
 */
export function testNoGradientNodes(graph) {
    const violations = [];
 ...
 */
export function testCenterOriginCompliance(graph) {
    const violations = [];
 ...
 */
export function testHsvToRgbWarning(graph) {
    const warnings = [];
 ...
 */
export function testSpectrumBinRange(graph) {
    const violations = [];
 ...
 */
export function testSpectrumRangeParameters(graph) {
    const violations = [];
    ...
    spectrumRangeNodes.forEach(node => {
        ...
        if (params.band) {
            ...
            if (!validBands.includes(params.band)) {
                violations.push({
                    type: 'audio_chain',
                    severity: 'major',
            ...
            const startBin = params.start_bin;
            const endBin = params.end_bin;
 ...
 */
export function testBeatNodeParameters(graph) {
    const violations = [];
 ...
 * CRITICAL: Out-of-range parameters cause runtime errors
 */
export function testChromagramParameters(graph) {
    const violations = [];
 ...
 */
export function testPaletteArrayFormat(graph) {
    const violations = [];
 ...
 */
export function testNodeTypeCompatibility(graph) {
    const violations = [];
 ...
 */
export function testSignalChainConnections(graph) {
    const violations = [];
 ...
 */
export function generateValidationReport(filename, result) {
