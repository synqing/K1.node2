...
export function Sidebar({ isConnected, onConnect, connectionIP, onIPChange }: SidebarProps) {
  ...
  return (
    <aside className="w-[var(--lib-w)] glass-elevated border-r relative z-10 p-4 flex flex-col gap-4 overflow-auto shadow-lg">
      ...
      {/* Connection Help */}
      <div className="mt-auto p-3 glass rounded-lg border border-[var(--k1-border-subtle)]">
